...
print("Press RIGHT SHIFT to toggle HOLDING Enter ON/OFF.")
print("Press ESC to exit.")

while True:
    if keyboard.is_pressed('esc'):
        if toggled:
            keyboard.release('enter')  # Release if holding
    ...
    if keyboard.is_pressed('right shift'):
        ...
        if toggled:
            keyboard.press('enter')  # HOLD Enter down
            print("Holding ENTER down!")
